...
/* Definitions for que01 */
osMessageQueueId_t que01Handle;
const osMessageQueueAttr_t que01_attributes = {
  .name = "que01"
};
/* Definitions for que02 */
osMessageQueueId_t que02Handle;
const osMessageQueueAttr_t que02_attributes = {
  .name = "que02"
};
...
/* Definitions for mtx01 */
osMutexId_t mtx01Handle;
const osMutexAttr_t mtx01_attributes = {
  .name = "mtx01"
};
...
const osSemaphoreAttr_t sem02_attributes = {
  .name = "sem02"
};
/* Definitions for Evt01 */
osEventFlagsId_t Evt01Handle;
const osEventFlagsAttr_t Evt01_attributes = {
  .name = "Evt01"
};
/* USER CODE BEGIN PV */
...
void task03start(void *argument);
void tim01Callback(void *argument);
void tim02Callback(void *argument);
...
int main(void)
{
  ...
  /* Create the mutex(es) */
  /* creation of mtx01 */
  mtx01Handle = osMutexNew(&mtx01_attributes);
  ...
  /* Create the timer(s) */
  /* creation of tim01 */
  tim01Handle = osTimerNew(tim01Callback, osTimerPeriodic, NULL, &tim01_attributes);

  /* creation of tim02 */
  tim02Handle = osTimerNew(tim02Callback, osTimerPeriodic, NULL, &tim02_attributes);
  ...
  /* Create the queue(s) */
  /* creation of que01 */
  que01Handle = osMessageQueueNew (32, sizeof(uint32_t), &que01_attributes);

  /* creation of que02 */
  que02Handle = osMessageQueueNew (32, sizeof(uint32_t), &que02_attributes);
  ...
  /* creation of task03 */
  task03Handle = osThreadNew(task03start, NULL, &task03_attributes);
  ...
  /* creation of Evt01 */
  Evt01Handle = osEventFlagsNew(&Evt01_attributes);
...
/* USER CODE BEGIN Header_task03start */
/**
* @brief Function implementing the task03 thread.
* @param argument: Not used
* @retval None
*/
/* USER CODE END Header_task03start */
void task03start(void *argument)
{
  /* USER CODE BEGIN task03start */
	/* Infinite loop */
	for (;;) {
		osDelay(1);
	}
  /* USER CODE END task03start */
}

/* tim01Callback function */
void tim01Callback(void *argument)
{
  /* USER CODE BEGIN tim01Callback */

  /* USER CODE END tim01Callback */
}

/* tim02Callback function */
void tim02Callback(void *argument)
{
  /* USER CODE BEGIN tim02Callback */

  /* USER CODE END tim02Callback */
}
